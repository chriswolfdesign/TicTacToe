...
class BoardTest(unittest.TestCase):
    ...
    def test_make_move_legal_move(self):
        player = HumanPlayer(PlayerChars.PLAYER_ONE)
        board = Board()
    ...
    def test_make_move_already_made(self):
        board = Board()
        player_one = HumanPlayer(PlayerChars.PLAYER_ONE)
        player_two = HumanPlayer(PlayerChars.PLAYER_TWO)
    ...
    def test_make_move_row_too_low(self):
        board = Board()
        player = HumanPlayer(PlayerChars.PLAYER_TWO)
